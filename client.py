...
class HTTPRequester:
    def __init__(self, url="http://0.0.0.0", data_port="1515", production_port="1516", ml_port="1517",
                 research="gracia", gmic_request="mirror y -fx_unsharp 1,10,20,2,0,2,1,1,0,0", root="./"):
        self.url = url
    ...
    def image_to_base64_and_hash(self, image, image_set, light, exposition=None):
        ...
        if exposition is not None:
            self.images[image_set][light][exposition] = string_image
    ...
    def requester(self):
        ...
        logging.info(f"Parsed JSON response: {self.json_response}")
